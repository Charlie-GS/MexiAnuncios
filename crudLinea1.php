...
<body>
  ...
  <header id="header" class="d-flex flex-column justify-content-center">
    ...
    <nav id="navbar" class="navbar nav-menu">
      <ul>
        <li><a href="crudLinea1.php" class="nav-link scrollto active" style="background-color: #136022;"><i class="fa-solid fa-1"></i></i><span>Línea 1</span></a></li>
        ...
        <li><a href="crudLinea3.php" class="nav-link scrollto" style="background-color: gray;"><i class="fa-solid fa-3"></i></i> <span>Línea 3</span></a></li>
    ...
    <div class="container-xl">
      <div class="table-responsive">
        <div class="table-wrapper">
          <div class="table-title" style="background-color: #136022;">
            <div class="row">
              <div class="col-sm-6">
          ...
          echo tablaEstacion(1, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(2, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(4, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(9, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(10, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(11, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(12, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(13, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(14, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(15, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(16, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(17, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(18, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(19, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(20, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(21, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(22, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(23, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(24, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(25, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(26, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(27, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(28, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(162, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(163, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(164, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(165, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(166, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(167, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(168, $conexion); 
          echo '<br><br>';
          echo tablaEstacion(169, $conexion); 
          ?>
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <select name="id_estacion" class="form-control" required>
                  ...
                  <?php
                  $sql = "SELECT * FROM estacion_mexi WHERE nume_linea = 1";
                  $result = mysqli_query($conexion, $sql);
                  while ($row = mysqli_fetch_assoc($result)) {
                  ?>
