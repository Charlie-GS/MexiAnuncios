  ...
  <header id="header" class="d-flex flex-column justify-content-center">
    ...
    <nav id="navbar" class="navbar nav-menu">
      <ul>
        ...
        <li><a href="crudLinea2.php" class="nav-link scrollto active" style="background-color: #9b0000;"><i class="fa-solid fa-2"></i></i> <span>Línea 2</span></a></li>
    ...
    <div class="container-xl">
      <div class="table-responsive">
        <div class="table-wrapper">
          <div class="table-title" style="background-color: #9b0000;">
            <div class="row">
              <div class="col-sm-6">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <select name="id_estacion" class="form-control" required>
                  ...
                  <?php
                  $sql = "SELECT * FROM estacion_mexi WHERE nume_linea = 2";
                  $result = mysqli_query($conexion, $sql);
                  while ($row = mysqli_fetch_assoc($result)) {
                  ?>
